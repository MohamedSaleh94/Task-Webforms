<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TaskDetails.aspx.cs" Inherits="MoSalehTask.UserTask.TaskDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="Status" Enabled="False" CssClass="form-control" />
            </div>
        </div>
     
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" ID="EditStatus"  Visible="False" Text="Edit Status For Task" CssClass="btn btn-default" OnClick="EditTask_Click" />
            </div>
        </div>
    </div>
    </asp:Content>
